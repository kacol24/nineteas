...
class IngredientResource extends Resource
{
    ...
    {
        return [
            'index'  => Inventory\IngredientResource\Pages\ListIngredients::route('/'),
            'create' => Inventory\IngredientResource\Pages\CreateIngredient::route('/create'),
            'edit'   => Inventory\IngredientResource\Pages\EditIngredient::route('/{record}/edit'),
        ];
    }
}
